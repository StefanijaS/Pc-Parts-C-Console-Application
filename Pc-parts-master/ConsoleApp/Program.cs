...
namespace ConsoleApp
{
    class Program
    {
        ...
        {
            PopulateDb();
            ClassWithMethods callTheMethods = new ClassWithMethods();
            Console.WriteLine("Welcome to our console application");
            Console.WriteLine("Just to know");
            Console.WriteLine("We have limits by the ordering.Minimum:1 part / 1 module, Maximum: 10 parts, 5 modules,1 configuration");
            callTheMethods.WelcomeMessage();
